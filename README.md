...
* For detailed information, see [the backend sub-repository](./backend/README.md)
...
* For detailed information, see [the frontend sub-repository](./frontend/README.md)
...
* For detailed information, see [the mobile sub-repository](./mobile/README.md)
